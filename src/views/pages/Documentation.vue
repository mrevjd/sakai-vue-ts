...
npm run dev</code></pre>
        ...
        <p class="text-lg mb-4">
            ...
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">sanitizeHtml()</span> before any <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">v-html</span> render or server-side persistence. The
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">Form Layout</span> demo (UI Components &rarr; Form Layout) shows the round-trip.
        </p>
