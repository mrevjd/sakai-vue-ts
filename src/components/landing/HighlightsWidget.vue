...
<template>
    <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
        <div class="text-center">
            <div class="text-foreground font-normal mb-2 text-4xl">Powerful Everywhere</div>
            <span class="text-muted-foreground text-xxl">Amet consectetur adipiscing elit...</span>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
            ...
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                <div class="flex items-center justify-center bg-purple-200 self-center lg:self-end" style="width: 4.2rem; height: 4.2rem; border-radius: 10px">
                    <IconMobile class="size-9 text-purple-700" />
                </div>
                <div class="leading-none text-foreground text-3xl font-normal">Congue Quisque Egestas</div>
                <span class="text-foreground text-xxl leading-normal ml-0 md:ml-2" style="max-width: 650px"
        ...
        <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
                <div class="flex items-center justify-center bg-yellow-200 self-center lg:self-start" style="width: 4.2rem; height: 4.2rem; border-radius: 10px">
                    <IconDesktop class="size-8 text-yellow-700" />
                </div>
                <div class="leading-none text-foreground text-3xl font-normal">Celerisque Eu Ultrices</div>
                <span class="text-foreground text-xxl leading-normal mr-0 md:mr-2" style="max-width: 650px"
